...
- [`vrana/adminer`](https://packagist.org/packages/vrana/adminer) 6.0.2 (installed automatically as a dependency, pinned to an exact version — see [Versioning](#versioning))
